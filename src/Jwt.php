...
class Jwt extends ObjectHelper implements OauthInterface
{
    ...
    protected function getAlgClass()
    {
        if (empty($this->supportedAlgs[$this->alg])) {
            throw new \InvalidArgumentException("{$this->alg} Algorithm not supported");
        }
    ...
    public function makeToken(array $claims = [], $jti = null): string
    {
        ...
        [$signer, $privateKey, $publicKey] = $this->getSigner();
    ...
    protected function generateRefreshToken()
    {
        if (empty($this->_token)) {
            throw new \RuntimeException('Please make token first');
        }
    ...
    {
        $this->blacklist->delete($refreshToken);
